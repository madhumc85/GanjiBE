...
public class AppController {
	...
	public Collection<Employee> listEmployees(ModelMap model) {
		final Collection<Employee> employees = new ArrayList<Employee>();
		employees.add(getEmployee(1));
		employees.add(getEmployee(2));
		employees.add(getEmployee(3));

        return employees.stream().filter(e -> e.getName()!=null ).collect(Collectors.toList());
