...
public class AppControllerTest {
    ...
    public void saveEmployeeWithSuccess() {
        ...
        doNothing().when(service).saveEmployee(any(Employee.class));
        //Assert.assertEquals(appController.saveEmployee(employees.get(0)), "success");
    ...
    public void updateEmployeeWithValidationError() {
        ...
        //Assert.assertEquals(appController.updateEmployee(employees.get(0), /*result, model,*/ "11111"), "registration");
    }
